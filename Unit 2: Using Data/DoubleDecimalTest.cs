...
class DoubleDecimalTest
{
   static void Main()
   {
      // Creates double and decimal variables
      double newDouble = 100000000000000000000000000000000000.0;
      decimal newDecimal = 100000000000000000000000000000000000.0M;

      // Displays the double and decimal variables
      WriteLine(newDouble);
      WriteLine(newDecimal);
   }
}
